...
const MODE_NOTES: Record<Mode, string> = {
  ...
  aggressive: "Every hitter on the slate ranked, including plays the model grades as Pass.",
};
...
function hitterPasses(hitter: HitterProjection, mode: Mode): boolean {
  ...
  // Aggressive shows the full ranked board so a thin slate is never indistinguishable from a broken one.
  return true;
}
